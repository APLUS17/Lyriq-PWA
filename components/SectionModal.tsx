  ...
  return (
    <>
      ...
      <div
        ...
        className="absolute top-14 right-6 w-48 bg-zinc-900/90 backdrop-blur-xl border border-white/10 text-gray-200 rounded-xl shadow-2xl z-20 p-1.5 origin-top-right animate-scale-in"
      >
